...
<head>
    ...
    <style>
        ...
        @media (max-width: 600px) {
            .login-box {
                padding: 30px 20px; /* Kurangi padding untuk layar kecil */
                border-radius: 0; /* Hilangkan border-radius agar memenuhi layar */
                box-shadow: none; /* Hilangkan bayangan untuk tampilan lebih bersih */
                min-height: 100vh; /* Pastikan login-box menutupi seluruh layar vertikal */
                display: flex;
            ...
            .logo-container i {
                font-size: 2.2rem; /* Sesuaikan ukuran ikon */
            }
